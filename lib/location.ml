...
let to_code_position (start_position, end_position) =
  ...
  let start_column = start_position.Lexing.pos_cnum - start_position.Lexing.pos_bol + 1 in
  let end_column = end_position.Lexing.pos_cnum - end_position.Lexing.pos_bol in
  { start_line; end_line; start_column; end_column }
;;

let dummy_code_pos = { start_line = 0; start_column = 0; end_line = 0; end_column = 0 }
